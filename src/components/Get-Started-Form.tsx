        ...
        <section id="contact" className="py-24 bg-white relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="relative">
                        <div className="bg-[#324a70]/80 backdrop-blur-xl p-10 rounded-[2.5rem] shadow-[0_32px_64px_-16px_rgba(29,45,69,0.2)] border border-white/10 relative z-10 overflow-hidden min-h-[500px] flex flex-col justify-center">
                                  ...
                                  <>
                                    ...
                                    <form className="space-y-6" onSubmit={handleSubmit}>
                                      ...
                                      <button
                                        ...
                                        className="w-full bg-[#1d2d45] text-white px-8 py-5 rounded-2xl hover:bg-[#3b5d91] transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:hover:scale-100 flex items-center justify-center gap-3 font-bold text-lg shadow-xl shadow-[#1d2d45]/10"
                                      >
                                        {isSubmitting ? (
                                          <>
                                            Sending...
