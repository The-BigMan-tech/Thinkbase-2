    ...
    <div className="bg-white min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h1 className="text-5xl lg:text-7xl font-bold text-[#1d2d45] mb-6 leading-tight">
            Let's Start Your <span className="text-[#324a70]">Journey</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="bg-[#1d2d45] text-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
          ...
          <div className="pt-8">
            <h3 className="text-2xl font-bold text-[#1d2d45] mb-8 text-center italic">Ready to transform your service delivery? Fill out the form below.</h3>
            <ContactForm />
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-24 text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-[#1d2d45] mb-6">Why ThinkBase?</h2>
